package com.devjethava.chplapp.view.fragment

import android.os.Bundle
import androidx.fragment.app.Fragment
import com.devjethava.chplapp.R
import com.devjethava.chplapp.databinding.FragmentBlank2Binding
...
class BlankFragment2 : BaseFragment<FragmentBlank2Binding>(R.layout.fragment_blank2) {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(param1: String) = BlankFragment2().apply {
